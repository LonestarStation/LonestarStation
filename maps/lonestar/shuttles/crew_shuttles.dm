...
//
/datum/shuttle_destination/shuttle2/root
	name = "Lonestar Station Transit Satellite"
	my_landmark = "cent_2"
...
/datum/shuttle_destination/shuttle2/root/get_arrival_message()
	return "Attention, [master.my_shuttle.visible_name] has arrived at the Lonestar Station Transit Satellite."

/datum/shuttle_destination/shuttle2/root/get_departure_message()
	return "Attention, [master.my_shuttle.visible_name] has departed the Lonestar Station Transit Satellite."
...
/datum/shuttle_destination/shuttle2/station_orbit
	...
	routes_to_make = list(
		...
		/datum/shuttle_destination/shuttle2/root = 60 SECONDS
	)
