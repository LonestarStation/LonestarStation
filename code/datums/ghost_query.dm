...
//Lonestar Ed.
/datum/ghost_query/raccoon
	role_name = "Lonestar Raccoon"
	question = "A Lonestar Raccoon has woken up on the facility. \
	Would you like to cause a little mischief?"
	cutoff_number = 3
	wait_time = 120 SECONDS

/datum/ghost_query/booze_bot
	role_name = "Booze Bot"
	question = "A bartending robot is about to reactivate and tend to its bar. \
