...
/mob/living/var/list/can_enter_vent_with = list(
	...
	/obj/screen,
	/obj/item/storage/backpack/raccpack, //Lonestar Ed. Also, consider adding belt items too.
	/obj/item/storage/belt/utility, //Lonestar Ed. I considered it. But not all of them.
