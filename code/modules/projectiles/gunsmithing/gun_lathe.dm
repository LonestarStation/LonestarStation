...
/*
		...
		acceptable_items |= /obj/item/stack/material
		acceptable_items |= /obj/item/paicard
		acceptable_items |= /obj/item/gunschematic
*/


/obj/machinery/gun_lathe
	name = "Quickdraw Assembly 5000"
	desc = "This machine is designed to read gun schematics and assemble parts into a near-finished product."
	icon = 'icons/obj/gunlathe.dmi'
	icon_state = "gunlathe"
	layer = 2.9
	density = 1
	anchored = 1
...
/obj/machinery/gun_lathe/Initialize()
	. = ..()
...
/obj/machinery/gun_lathe/Destroy()
	QDEL_NULL(soundloop)
	return ..()
...
/obj/machinery/gun_lathe/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(src.broken > 0)
...
/obj/machinery/gun_lathe/attack_ai(mob/user as mob)
	if(istype(user, /mob/living/silicon/robot) && Adjacent(user))
		attack_hand(user)

/obj/machinery/gun_lathe/attack_hand(mob/user as mob)
...
/obj/machinery/gun_lathe/proc/wzhzhzh(var/seconds as num) // Whoever named this proc is fucking literally Satan. ~ Z
...
/obj/machinery/gun_lathe/proc/abort()
	operating = FALSE // Turn it off again aferwards
	if(icon_state == "gunlathe1")
		icon_state = "gunlathe"
	updateUsrDialog()
	soundloop.stop()

/obj/machinery/gun_lathe/proc/stop()
...
/obj/machinery/gun_lathe/proc/dispose(var/message = 1)
...
/obj/machinery/gun_lathe/proc/broke()
...
/obj/machinery/gun_lathe/proc/fail()
...
/obj/machinery/gun_lathe/Topic(href, href_list)
	if(..())
		return
...
/obj/machinery/gun_lathe/verb/Eject()
	set src in oview(1)
	set category = "Object"
...
/obj/machinery/gun_lathe/CanPass(atom/movable/mover, turf/target, height=0, air_group=0)
	if(!mover)
		return 1
	...
	return ..()
/*
/obj/machinery/gun_lathe/advanced // specifically for complex recipes
...
/datum/recipe/splat/before_cook(obj/container)
	if(istype(container, /obj/machinery/gun_lathe))
		var/obj/machinery/gun_lathe/M = container
		M.muck_start()
