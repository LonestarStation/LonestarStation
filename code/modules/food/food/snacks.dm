...
/obj/item/reagent_containers/food/snacks/xenomeat/roachmeat // Substitute for recipes requiring xeno meat.
	name = "cockroach meat"
	desc = "A slab of cockroach meat."
	icon_state = "xenomeat"
	filling_color = "#43DE18"
	center_of_mass = list("x"=16, "y"=10)
	bitesize = 6
	backyard_grilling_product = /obj/item/reagent_containers/food/snacks/xenomeat/cockroach/charred
//	backyard_grilling_announcement = "smokes as the poison burns away."
	drying_wetness = 60
	dried_type = /obj/item/reagent_containers/food/snacks/jerky/cockroach

/obj/item/reagent_containers/food/snacks/xenomeat/spidermeat/charred
	name = "charred cockroach meat"
	desc = "A slab of cockroach meat with char lines."
...
/obj/item/reagent_containers/food/snacks/nettlesoup
	name = "nettle soup"
	desc = "To think, the botanist could beat you to death with one of these."
...
/obj/item/reagent_containers/food/snacks/meatballspagetti
	...
	desc = "Now thats a nice-ah meatball!"
...
/obj/item/reagent_containers/food/snacks/sliceable/bread
	name = "bread"
	desc = "The foundation of human civilization."
	icon_state = "bread"
...
/obj/item/reagent_containers/food/snacks/dip/attackby(obj/item/reagent_containers/food/snacks/item as obj, mob/user as mob)
	...
	if(returningitem)
		...
		var/memed = 0
		item.reagents.trans_to_obj(returningitem, item.reagents.total_volume) //Old chip to new chip chip
...
/obj/item/reagent_containers/food/snacks/burrito_hell/Initialize()
	...
	reagents.add_reagent("condensedcapsaicin", 10) //what could possibly go wrong //me >:3 theDemonPizza
...
/obj/item/reagent_containers/food/snacks/wasabi_peas
	...
	desc = "A bag of Hadokikku brand wasabi peas, a delicious snack imported directly from Sol."
...
/obj/item/reagent_containers/food/snacks/garami/Initialize()
	. = ..()
