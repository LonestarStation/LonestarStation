...
/obj/item/reagent_containers/food/snacks/xenomeat/roachmeat // Substitute for recipes requiring xeno meat.
	...
	center_of_mass = list("x"=16, "y"=10)
	bitesize = 6
	backyard_grilling_product = /obj/item/reagent_containers/food/snacks/xenomeat/roachmeat/charred
	backyard_grilling_announcement = "kind of stinks."
	drying_wetness = 60
...
obj/item/reagent_containers/food/snacks/xenomeat/roachmeat/Initialize()
	. = ..()
	reagents.add_reagent("protien", 8)

/obj/item/reagent_containers/food/snacks/xenomeat/roachmeat/charred
