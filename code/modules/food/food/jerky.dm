...
/obj/item/reagent_containers/food/snacks/jerky/cockroach
	name = "dried cockroach meat"
	desc = "A piece of thick, green dried meat, full of.. thingies. Sometimes they crunch."
	icon_state = "spiderjerky_charred"

/obj/item/reagent_containers/food/snacks/jerky/cockroach/get_drying_state()
	return "meat_dried"

/obj/item/reagent_containers/food/snacks/jerky/cockroach/Initialize()
	. = ..()
