...
/datum/event_container/mundane
	...
	available_events = list(
		...
		//new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Raccoon", 			/datum/event/raccoon_infestation,	100, 	list(ASSIGNMENT_ENGINEER = 20, ASSIGNMENT_SECURITY = 30, ASSIGNMENT_MEDICAL = 30), 1),
	)
