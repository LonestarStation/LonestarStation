...
/datum/lore/system/vir
	...
	planets = list("Sif")
	locations = list(
		new /datum/lore/location("New Reykjavik on Sif, Vir", list(ATC_ALL_CIV)), //sivian locations don't need 'on sif' and virite locations dont need 'in vir'-- theyre local
...
//		new /datum/lore/location("a location in the Anomalous Region", list(ATC_SCI)),
		...
		new /datum/lore/location("Magni in Vir", list(ATC_TYPICAL)),
		new /datum/lore/location("Thor in Vir", list(ATC_TYPICAL)),
