/datum/event2/meta/raccoon_infestation
	name = "raccoon infestation"
	event_class = "raccoons"
	departments = list(DEPARTMENT_SECURITY, DEPARTMENT_MEDICAL, DEPARTMENT_EVERYONE, DEPARTMENT_ENGINEERING)
	chaos = 5
	chaotic_threshold = EVENT_CHAOS_THRESHOLD_LOW_IMPACT
	event_type = /datum/event2/event/ghost_pod_spawner/raccoon_infestation
	regions = list(EVENT_REGION_PLAYER_MAIN_AREA)

/datum/event2/meta/raccoon_infestation/get_weight()
	. = 30
