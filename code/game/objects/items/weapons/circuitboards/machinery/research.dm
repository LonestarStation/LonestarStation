...
/obj/item/circuitboard/gun_lathe  //Lonestar Ed. (yeehaw, guns, etc)
	name = T_BOARD("gun lathe")
	build_path = /obj/machinery/gun_lathe
	board_type = new /datum/frame/frame_types/machine
	origin_tech = list(TECH_ENGINEERING = 2, TECH_DATA = 2, TECH_COMBAT = 2)
	req_components = list(
							/obj/item/stock_parts/matter_bin = 2,
							/obj/item/stock_parts/manipulator = 2,
