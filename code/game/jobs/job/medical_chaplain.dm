...
/datum/job/chaplain
	...
	access = list(access_medical, access_morgue, access_chapel_office, access_crematorium, access_psychiatrist, access_maint_tunnels, access_operations)
	minimal_access = list(access_medical, access_chapel_office, access_crematorium, access_psychiatrist, access_operations)
...
/datum/job/chaplain/equip(var/mob/living/carbon/human/H, var/alt_title, var/ask_questions = TRUE)
	...
	spawn(1)
		...
		var/accepted = 0
		var/outoftime = 0
		spawn(300) // 30 seconds to choose
			outoftime = 1
